...
void app_manager::startMove() {
    ...
    while (true) {
        ...
        for (size_t i = 0; i < lines.size();) {
            ...
            lines[i].update(now, this->explosionChance, this->minExplosionRadius, this->maxExplosionRadius, explosions);
        ...
        for (size_t i = 0; i < explosions.size();) {
            explosions[i].setDimensions(this->consoleWidth, this->consoleHeight);
